...
karenList = ["You will call me by my husband's rank", "Keep'm coming, pal, I went through child birth _and_ child death",
"Um, yeah. I'm gonna have to speak to your manager...", "This is not very _live love laugh_ of you. You should be ashamed of yourself.", 
...
"I demand this account be deleted.", "I bet you were vaccinated."]
...
subreddit = reddit.subreddit("TellMeYoureTesting")
    ...
    for comment in subreddit.stream.comments():
        ...
        if karenMatch is None:
            ...
            if cID not in compareList:
                comment.reply(karenList[rand.randint(0,3)] + '\n\n' + karenSignature)
